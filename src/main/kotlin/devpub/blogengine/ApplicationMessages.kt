...
object ApplicationMessages {
    ...
    const val INVALID_EMAIL = "Недопустимый адрес эл. почты"
    ...
    const val INVALID_MAX_USER_NAME_LENGTH = "Максимально допустимая длина - ${User.MAX_NAME_LENGTH} символов"
    const val INVALID_MAX_USER_EMAIL_LENGTH = "Максимально допустимая длина - ${User.MAX_EMAIL_LENGTH} символов"
    const val INVALID_MIN_USER_PASSWORD_LENGTH = "Минимально допустимая длина - ${User.MIN_PASSWORD_LENGTH} символов"
